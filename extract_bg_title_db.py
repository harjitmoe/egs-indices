...
def extract_bg_title_db():
    ...
    if not os.path.exists(
            r"../../egs/0003 - (Sketchbook and Extras)/0001 - Filler Sketchbook"
    ) or not os.path.exists(r"../../egsbg"):
        print("Not running on HarJIT's machine, not regenerating Bg*.txt")
        return
    db = {}
    dbt = {}
    ls = [
        "backgrounds_0.html", "backgrounds_1.html", "backgrounds_2.html",
        "backgrounds_3.html", "backgrounds_4.html", "backgrounds_5.html",
        "backgrounds_6.html"
    ]
